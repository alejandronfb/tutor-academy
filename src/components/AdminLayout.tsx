...
import {
  LayoutDashboard, Users, BookOpen, KeyRound, Briefcase, Trophy, Award, ArrowLeft, Shield, Loader2,
} from "lucide-react";
      ...
      <SidebarContent>
        <div className="px-4 py-4">
          <Link to="/admin" className="flex items-center gap-2">
            <div className="bg-destructive flex h-8 w-8 shrink-0 items-center justify-center rounded-lg">
